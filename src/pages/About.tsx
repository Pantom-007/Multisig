...
const About = ({ className }: Props) => {
  return (
    <Center className={className}>
      <h1>Multisig values</h1>
      <ul className="values">
        <li>
          <h2>Open</h2>
          <p>
            Multisig is open-source from the get-go. The back-end and front-end code can be{' '}
            <a
              href="https://github.com/ChainSafe/Multisig"
              target="_blank"
              rel="noreferrer"
            >
              found on GitHub
        ...
        <li>
          ...
          <p>
            While Multisig uses an open source indexer, the database is trust minimized and only
        ...
        <li>
          <h2>Interoperable</h2>
          Multisig doesn&apos;t create a walled garden. You can create a multisig on-chain anywhere,
          Multisig will show it right away.
        </li>
        <li>
